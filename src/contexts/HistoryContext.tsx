...
const firstPeriodHistory: HistoricalData = {
  ...
  balanceSheet: {
    assets: { "資産合計": 1685000, "流動資産": { "現金": 1685000 }, "固定資産": {} },
    liabilities: { "負債合計": 500000, "流動負債": {}, "固定負債": { "借入金": 500000 } },
    equity: { "純資産合計": 1185000, "資本金": 1000000, "利益剰余金": 185000 }
  },
  incomeStatement: {
    "収益": { "売上": 800000 },
    "費用": { 
        "売上原価": { "仕入": 500000 }, 
        "販売費及び一般管理費": { "給料": 200000 }, 
        "営業外費用": { "支払利息": 5000 }, 
        "特別損失": { "固定資産売却損": 20000 }, 
        "法人税等": { "法人税等": 100000 },
        "費用合計": 825000 
