                        ...
                        {history.map((periodData, index) => (
                            <tr key={index} className="hover:bg-gray-50">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-center space-x-2">
                                    <Link to={`/income-statement/${index}`} className="inline-block bg-green-100 text-green-800 font-semibold px-3 py-1 text-xs rounded-full hover:bg-green-200 transition-colors">P/L</Link>
                                    <Link to={`/balance-sheet/${index}`} className="inline-block bg-blue-100 text-blue-800 font-semibold px-3 py-1 text-xs rounded-full hover:bg-blue-200 transition-colors">B/S</Link>
                                    <Link to={`/cash-flow-statement/${index}`} className="inline-block bg-yellow-100 text-yellow-800 font-semibold px-3 py-1 text-xs rounded-full hover:bg-yellow-200 transition-colors">C/F</Link>
                                </td>
                            </tr>
                        ))}
                    </tbody>
                ...
                {history.map((periodData, index) => (
                    <div key={index} className="bg-white rounded-lg shadow-md p-4">
                        ...
                        <div className="mt-3 pt-3 border-t text-center space-x-4">
                            <Link to={`/income-statement/${index}`} className="inline-block bg-green-100 text-green-800 font-semibold px-4 py-2 rounded-full hover:bg-green-200 transition-colors">P/L</Link>
                            <Link to={`/balance-sheet/${index}`} className="inline-block bg-blue-100 text-blue-800 font-semibold px-4 py-2 rounded-full hover:bg-blue-200 transition-colors">B/S</Link>
                            <Link to={`/cash-flow-statement/${index}`} className="inline-block bg-yellow-100 text-yellow-800 font-semibold px-4 py-2 rounded-full hover:bg-yellow-200 transition-colors">C/F</Link>
                        </div>
                    </div>
                ))}
            </div>
